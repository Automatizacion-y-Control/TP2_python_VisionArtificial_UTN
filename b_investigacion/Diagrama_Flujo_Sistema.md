...
La cuantificación se realiza mediante:
...
y si la detección es estable durante varios frames consecutivos.
...
procesamiento de visión, y actuación embebida.  
...
c) y actuar físicamente mediante el ESP32-S3 y el LED WS2812B.  
